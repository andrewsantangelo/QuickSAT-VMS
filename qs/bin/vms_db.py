...
#    
    ...
    def get_recording_session_id(self):
        stmt = '''
        ...
        with self.lock:
            self.cursor.execute(stmt)
            results = self.cursor.fetchone()    
            row_recording_session = results['recording_session_id']
            return row_recording_session     
    ...
    def record_status_in_db(self,status):
        with self.lock:
            self.cursor.execute('''
    ...
    def set_test_connection(self,flag):
        stmt = '''
